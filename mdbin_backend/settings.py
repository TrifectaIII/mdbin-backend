"""
Django settings for mdbin_backend project.
...
RECAPTCHA_V2_SECRET_KEY = config['RECAPTCHA_SECRET_KEY']
...
ROOT_URLCONF = 'mdbin_backend.urls'
...
WSGI_APPLICATION = 'mdbin_backend.wsgi.application'
